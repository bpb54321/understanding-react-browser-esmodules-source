...
export const __CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE =
  ReactSharedInternals;
export const __COMPILER_RUNTIME = deprecatedAPIs;
export const act = function (callback) {
...
export const captureOwnerStack = function () {
...
export const useDebugValue = function (value, formatterFn) {
