import * as Scheduler from "./scheduler.development.js";
...
function isTagValidWithParent(tag, parentTag, implicitRootScope) {
  ...
  switch (tag) {
    ...
    case "html":
      return (
        (implicitRootScope && "#document" === parentTag) || null === parentTag
      );
    case "body":
      return (
        (implicitRootScope &&
        ...
        a: {
          ...
          switch (partialState.tag) {
            ...
            case UpdateState:
              ...
              if (null === partialState || undefined === partialState) {
                break a;
              }
...
function updateSuspenseComponent(current, workInProgress, renderLanes) {
  ...
  if (null === current) {
    ...
    if (JSCompiler_object_inline_componentStack_2453) {
      return (
        reuseSuspenseHandlerOnStack(workInProgress),
        (JSCompiler_object_inline_componentStack_2453 = workInProgress.mode),
        (JSCompiler_object_inline_message_2450 =
    ...
    if (didSuspend) {
      ...
      if (
        ...
        (JSCompiler_object_inline_stack_2452 =
          0 !==
          (JSCompiler_object_inline_stack_2452 &
            (JSCompiler_object_inline_digest_2451.suspendedLanes | renderLanes))
            ? 0
            : JSCompiler_object_inline_stack_2452),
    ...
    return (
      ...
      null !== instance
        ...
        : ((JSCompiler_object_inline_componentStack_2453 =
          ...
          (JSCompiler_object_inline_componentStack_2453.flags |= 2)),
      (JSCompiler_object_inline_componentStack_2453.return = workInProgress),
      (JSCompiler_object_inline_stack_2452.return = workInProgress),
      (JSCompiler_object_inline_stack_2452.sibling =
        JSCompiler_object_inline_componentStack_2453),
      (workInProgress.child = JSCompiler_object_inline_stack_2452),
...
function updateSuspenseListComponent(current, workInProgress, renderLanes) {
  ...
  switch (revealOrder) {
    ...
    case "backwards":
      ...
      break;
    case "together":
      initSuspenseListRenderState(workInProgress, !1, null, null, undefined);
      break;
    default:
      workInProgress.memoizedState = null;
  }
  ...
  switch (workInProgress.tag) {
    ...
    case 9:
      return (
        ...
        markComponentRenderStarted(workInProgress),
        (returnFiber = callComponentInDEV(returnFiber, prevSibling, undefined)),
        markComponentRenderStopped(),
        (workInProgress.flags |= 1),
        reconcileChildren(current, workInProgress, returnFiber, renderLanes),
        workInProgress.child
    ...
    if (null !== lastEffect) {
      ...
      do {
        if (
          ...
          undefined !== lastEffect && "function" !== typeof lastEffect)
        ) {
      ...
      if (exitStatus === RootErrored) {
        ...
        if (0 !== errorRetryLanes) {
          ...
          a: {
            ...
            wasRootDehydrated &&
              (prepareFreshStack(exitStatus, errorRetryLanes$jscomp$0).flags |=
                256);
...
function doubleInvokeEffectsOnFiber(root, fiber) {
  var shouldDoubleInvokePassiveEffects =
    2 < arguments.length && undefined !== arguments[2] ? arguments[2] : !0;
  setIsStrictModeForDevtools(!0);
  try {
...
export const createRoot = function (container, options) {
