...
*/
import * as Scheduler from "./scheduler.production.js";
import * as React from "./react.production.js";
import * as ReactDOM from "./react-dom.production.js";
            ...
            case 0:
              ...
              updateLane =
                "function" === typeof workInProgress
                  ...
                  : workInProgress;
              if (null === updateLane || undefined === updateLane) {
                break a;
              }
...
function resolveClassComponentProps(Component, baseProps) {
  ...
  if ((Component = Component.defaultProps)) {
    ...
    for (var propName$73 in Component) {
      undefined === newProps[propName$73] &&
        ...
        for (defaultChecked in nextProps) {
          (propKey$205 = nextProps[defaultChecked]),
            ...
            !nextProps.hasOwnProperty(defaultChecked) ||
              propKey$205 === propKey ||
              (undefined === propKey$205 && undefined === propKey) ||
              setPropOnCustomElement(
                domElement,
                tag,
                defaultChecked,
